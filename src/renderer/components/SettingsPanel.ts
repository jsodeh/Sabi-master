...
export interface SettingsPanelState {
  isOpen: boolean;
  activeTab: 'general' | 'learning' | 'accessibility' | 'notifications';
...
export class SettingsPanel {
  ...
  constructor(container: HTMLElement, initialPreferences: ExtendedUserPreferences) {
  ...
  public updatePreferences(preferences: ExtendedUserPreferences): void {
  ...
  private renderLearningTab(): string {
    return `
      <div class="tab-content">
        <div class="setting-group">
  ...
  private renderAccessibilityTab(): string {
    return `
      <div class="tab-content">
        <div class="setting-group">
  ...
  private attachEventListeners(): void {
    ...
    this.container.addEventListener('click', (e) => {
      ...
      if (tabBtn) {
        const tab = tabBtn.dataset.tab as typeof this.state.activeTab;
  ...
  private handleSettingChange(settingPath: string, element: HTMLInputElement | HTMLSelectElement): void {
